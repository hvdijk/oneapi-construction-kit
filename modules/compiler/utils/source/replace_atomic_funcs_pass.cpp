...
const std::map<std::string, AtomicRMWInst::BinOp> atomicMap = {
    ...
    {"_Z8atom_minPU3AS1Vll", AtomicRMWInst::UMin},
    {"_Z8atom_minPU3AS3Vll", AtomicRMWInst::UMin},
    {"_Z8atom_minPU3AS4Vll", AtomicRMWInst::UMin},
    ...
    {"_Z10atomic_minPU3AS1Vll", AtomicRMWInst::UMin},
    {"_Z10atomic_minPU3AS3Vll", AtomicRMWInst::UMin},
    {"_Z10atomic_minPU3AS4Vll", AtomicRMWInst::UMin},
    ...
    {"_Z8atom_maxPU3AS1Vll", AtomicRMWInst::UMax},
    {"_Z8atom_maxPU3AS3Vll", AtomicRMWInst::UMax},
    {"_Z8atom_maxPU3AS4Vll", AtomicRMWInst::UMax},
    ...
    {"_Z10atomic_maxPU3AS1Vll", AtomicRMWInst::UMax},
    {"_Z10atomic_maxPU3AS3Vll", AtomicRMWInst::UMax},
    {"_Z10atomic_maxPU3AS4Vll", AtomicRMWInst::UMax},
